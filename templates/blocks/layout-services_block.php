        ...
        <?php foreach ( $services as $service ) : ?>
            ...
            <div class="service grid-x direction--<?php echo esc_attr( $direction ); ?>">
                <div class="small-12 large-8 cell">
                    <div class="service__gallery owl-carousel">
                        <?php foreach ( $service_gallery as $image ) : ?>
                            <img class="service__image" src="<?php echo esc_url( $image['url'] ); ?>" alt="<?php echo esc_attr( $image['alt'] ); ?>">
                        <?php endforeach; ?>
                    </div>
                </div>
                <div class="small-12 large-4 cell service-cell">
